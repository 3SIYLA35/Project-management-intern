    ...
    <div className="w-64 flex-shrink-0 border-r border-gray-800 p-4">
      ...
      <nav>
        <div className="space-y-1">
          ...
          {profile?.role==='hr' && (
          <button 
            className={`flex items-center px-4 py-2 w-full ${activeItem==='invite'?'text-white bg-purple-600':'text-gray-300'} rounded-lg`} 
            onClick={() => handleNavigation('/admin/invite')}
          >
            <span className="inline-block mr-3">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
          ...
          <button 
            className={`flex items-center px-4 py-2 w-full ${activeItem==='logout' ? 'text-white bg-purple-600' : 'text-gray-300'} rounded-lg`} 
